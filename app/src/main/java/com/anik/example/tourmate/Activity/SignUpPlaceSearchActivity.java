...
import com.anik.example.tourmate.Adapter.SignUpLocationAutoComplete;
...
public class SignUpPlaceSearchActivity extends AppCompatActivity implements PredictionInterface {
    ...
    private void searchViewAction() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                signUpLocationAutoComplete.getFilter().filter(newText);
                return true;
            }
        });
    ...
    private void initRecyclerView() {
        ...
        signUpLocationAutoComplete = new SignUpLocationAutoComplete(getApplicationContext(), predictions, this);
        locationSearchRV.setLayoutManager(new LinearLayoutManager(this));
        locationSearchRV.setAdapter(signUpLocationAutoComplete);
    ...
    public void openMap(View view) {
        Intent intent = new Intent(SignUpPlaceSearchActivity.this,SignUpLocationMapActivity.class);
