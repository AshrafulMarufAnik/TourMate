...
import com.anik.example.tourmate.Adapter.PhoneUserLocationAutoComplete;
...
public class PhoneUserLocationSearchActivity extends AppCompatActivity implements PredictionInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phone_user_location_search);
    ...
    private void searchViewAction() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                phoneUserLocationAutoCompleteAdapter.getFilter().filter(newText);
                return true;
            }
        });
    ...
    private void initRecyclerView() {
        ...
        phoneUserLocationAutoCompleteAdapter = new PhoneUserLocationAutoComplete(getApplicationContext(), predictions, this);
        locationSearchRV.setLayoutManager(new LinearLayoutManager(this));
        locationSearchRV.setAdapter(phoneUserLocationAutoCompleteAdapter);
